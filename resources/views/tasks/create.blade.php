    ...
    <div class="mx-auto w-1/3">
        ...
        <form action="{{ route('tasks.store') }}" method="post" class="space-y-6">
            ...
            <x-form.wrapper state="{ label: false }">
                ...
                <x-form.input name="name[en]" error="name.en" text="name_en" required/>
                <x-form.error name="name.en"/>
            </x-form.wrapper>

            <x-form.wrapper state="{ label: false }">
                <x-form.label name="name[ka]" text="name_ka"/>
                <x-form.input name="name[ka]" error="name.ka" text="name_ka" required/>
            ...
            <x-form.wrapper state="{ label: false }">
                ...
                <x-form.input name="due_date" type="date" required/>
