...
Route::get('overdues', [OverdueController::class, 'index'])->name('overdues')->middleware('auth');
Route::post('overdues', [OverdueController::class, 'destroy'])->name('overdues')->middleware('auth');
